...
/**
 * Full-bleed photographic page hero: a darkened architectural photograph with
 * the page title set over it. The gradient overlay keeps text at AA contrast
 * regardless of the underlying image. Swap the file in /public/images to change
 * the imagery — no code change needed.
 */
    ...
    <section className="relative isolate overflow-hidden bg-ink text-bone">
      ...
      <Container className="relative">
        <div className="max-w-prose py-24 sm:py-28 lg:py-32">
          <Eyebrow className="text-maroon-light">{eyebrow}</Eyebrow>
